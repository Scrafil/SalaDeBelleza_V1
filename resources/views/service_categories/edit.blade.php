    ...
    <div class="card gilded p-4 shadow-sm">
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between mb-4 gap-3">
            <div>
                ...
                <p class="text-muted small mb-0">Actualiza la información de la categoría {{ $serviceCategory->name }}</p>
            </div>
        ...
        <form action="{{ route('service-categories.update', $serviceCategory->id) }}" method="POST">
            ...
            <button type="submit" class="btn btn-gold">Actualizar Categoría</button>
        </form>
    </div>
</div>
@endsection